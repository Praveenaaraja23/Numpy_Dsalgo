...
public class DataStructures_sd {
	...
	public void the_user_is_in_homepage_after_signin() {
		...
		LoggerLoad.info("user is in" + hometitle + " page");
	...
	public void the_user_be_directed_to_data_structures_in_data_structures_page() {
		...
		LoggerLoad.info("user is in" + dstitle + " page");
	...
	public void the_user_be_directed_to_time_complexity_in_data_structures_page() {
		...
		LoggerLoad.info("user is in" + dstimetitle + " page");
	}
	...
	public void the_user_should_be_redirected_to_a_page_having_an_with_a_run_button_to_test_in_the_time_complexity_page(
		...
		LoggerLoad.info("user is in" + dstimetryeditortitle + " page");
	}

	// @Try_Editor_in_DS_with_DataDriven

	@Given("The user lands in the tryEditor page for DataStructures page")
	public void the_user_lands_in_the_try_editor_page_for_data_structures_page() {
		ds_pf.GetStarted();
		ds_pf.Timecomplexity();
		ds_pf.TryHere();
		LoggerLoad.info("The user is on the Tryeditor page for DataStructures Module");
	}

	@When("^The user enters the valid and invalid pythoncode input from sheet (.*) and (.*) in DataStructures$")
	public void the_user_enters_the_valid_and_invalid_pythoncode_input_from_sheet_and_in_data_structures(
	...
	@Then("^The user able to see output in the console with valid and invalid from excelsheet (.*) and (.*) in DataStructures$")
	public void the_user_able_to_see_output_in_the_console_with_valid_and_invalid_from_excelsheet_and_in_data_structures(
			String Sheetname, Integer Rownumber) throws InterruptedException, InvalidFormatException, IOException {
	...
	@Then("^The user gets the error message from excelsheet (.*) and (.*)$")
	public void The_user_gets_the_error_message_from_excelsheet(String Sheetname, Integer Rownumber)
	...
	public void the_user_lands_in_the_data_structures_page_after_logged_in() {
		ds_pf.GetStarted();
		ds_pf.Timecomplexity();
	...
	public void the_user_clicks_practice_questions_link_in_data_structures() {
	...
	public void the_user_should_be_redirected_to_practice_questions_page_in_data_structures() {
