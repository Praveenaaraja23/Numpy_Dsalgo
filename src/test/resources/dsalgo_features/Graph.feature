...
Background: The user able to land on Home page after entering valid Username and Password fields
    ...
    When The user entered the valid and invalid pythoncode input from sheet <Sheetname> and <RowNumber> in Graph module
    Then The user will able to see output in the console with valid and invalid from excelsheet <Sheetname> and <RowNumber> in Graph module
   ...
   Scenario Outline: The user is able to run code in tryEditor for Graph page
    Given The user land in the tryEditor page for Graph page module
    When The user entered the valid and invalid pythoncode input from sheet <Sheetname> and <RowNumber> in Graph module
    Then The user getting the graph module error message from excelsheet <Sheetname> and <RowNumber>
    Examples:
      |Sheetname  |RowNumber  |
      |phythoncode|         1 |
      |phythoncode|         2 | 
    ...
    When The user entered the valid and invalid pythoncode input from sheet <Sheetname> and <RowNumber> in Graph Representations module
    Then The user will able to see output in the console with valid and invalid from excelsheet <Sheetname> and <RowNumber> in Graph Representations module
   ...
   Scenario Outline: The user is able to run code in tryEditor for Graph Representations page
    Given The user land in the tryEditor page for Graph Representations page module
    When  The user entered the valid and invalid pythoncode input from sheet <Sheetname> and <RowNumber> in Graph Representations module
    Then The user getting the invaild error message from excelsheet <Sheetname> and <RowNumber>
    Examples:
      |Sheetname  |RowNumber  |
      |phythoncode|         1 |
      |phythoncode|         2 | 
